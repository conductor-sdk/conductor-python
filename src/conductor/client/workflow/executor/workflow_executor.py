...
class WorkflowExecutor:
    ...
    def remove_workflow(self, workflow_id: str, archive_workflow: bool = None) -> None:
        ...
        return self.workflow_client.delete(workflow_id=workflow_id, **kwargs)
    ...
    def terminate(
        ...
        return self.workflow_client.terminate1(workflow_id=workflow_id, **kwargs)
    ...
    def skip_task_from_workflow(
        ...
        return self.workflow_client.skip_task_from_workflow(
            workflow_id=workflow_id, task_reference_name=task_reference_name, **kwargs
        )
