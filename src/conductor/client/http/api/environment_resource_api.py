...
class EnvironmentResourceApi(object):
    ...
    def get1(self, key, **kwargs):  # noqa: E501
        """Get the environment value by key  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get1(key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get1_with_http_info(key, **kwargs)  # noqa: E501
        else:
            (data) = self.get1_with_http_info(key, **kwargs)  # noqa: E501
            return data

    def get1_with_http_info(self, key, **kwargs):  # noqa: E501
        """Get the environment value by key  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get1_with_http_info(key, async_req=True)
        >>> result = thread.get()
        ...
        if ('key' not in params or
                params['key'] is None):
            raise ValueError("Missing the required parameter `key` when calling `get1`")  # noqa: E501
