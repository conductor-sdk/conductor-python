...
class UserResourceApi(object):
    ...
    def send_invite_email(self, id, **kwargs):  # noqa: E501
        """Send an email with a link to this cluster  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.send_invite_email(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: (required)
        :param ConductorUser body:
        :return: object
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.send_invite_email_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.send_invite_email_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def send_invite_email_with_http_info(self, id, **kwargs):  # noqa: E501
        """Send an email with a link to this cluster  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.send_invite_email_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method send_invite_email" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `send_invite_email`")  # noqa: E501
