...
class ApplicationResourceApi(object):
    ...
    def delete_tag_for_application(self, id, **kwargs):  # noqa: E501
        """Delete a tag for application  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_tag_for_application(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_tag_for_application_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_tag_for_application_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def delete_tag_for_application_with_http_info(self, id, **kwargs):  # noqa: E501
        """Delete a tag for application  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_tag_for_application_with_http_info(id, async_req=True)
        >>> result = thread.get()
    ...
    def put_tag_for_application(self, id, **kwargs):  # noqa: E501
        """Put a tag to application  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_tag_for_application(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.put_tag_for_application_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.put_tag_for_application_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def put_tag_for_application_with_http_info(self, id, **kwargs):  # noqa: E501
        """Put a tag to application  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_tag_for_application_with_http_info(id, async_req=True)
        >>> result = thread.get()
