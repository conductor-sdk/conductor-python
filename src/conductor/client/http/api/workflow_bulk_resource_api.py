...
class WorkflowBulkResourceApi(object):
    ...
    def terminate1(self, body, **kwargs):  # noqa: E501
        """Terminate workflows execution  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.terminate1(body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.terminate1_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.terminate1_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def terminate1_with_http_info(self, body, **kwargs):  # noqa: E501
        """Terminate workflows execution  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.terminate1_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `terminate1`")  # noqa: E501
