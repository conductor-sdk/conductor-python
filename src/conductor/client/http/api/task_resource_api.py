...
class TaskResourceApi(object):
    ...
    def signal_workflow_task_a_sync(self, body, workflow_id, status, **kwargs):  # noqa: E501
        """Update running task in the workflow with given status and output asynchronously  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.signal_workflow_task_a_sync(body, workflow_id, status, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.signal_workflow_task_a_sync_with_http_info(body, workflow_id, status, **kwargs)  # noqa: E501
        else:
            (data) = self.signal_workflow_task_a_sync_with_http_info(body, workflow_id, status, **kwargs)  # noqa: E501
            return data

    def signal_workflow_task_a_sync_with_http_info(self, body, workflow_id, status, **kwargs):  # noqa: E501
        """Update running task in the workflow with given status and output asynchronously  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.signal_workflow_task_a_sync_with_http_info(body, workflow_id, status, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'workflow_id', 'status']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method signal_workflow_task_a_sync" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `signal_workflow_task_a_sync`")  # noqa: E501
        # verify the required parameter 'workflow_id' is set
        if ('workflow_id' not in params or
                params['workflow_id'] is None):
            raise ValueError("Missing the required parameter `workflow_id` when calling `signal_workflow_task_a_sync`")  # noqa: E501
        # verify the required parameter 'status' is set
        if ('status' not in params or
                params['status'] is None):
            raise ValueError("Missing the required parameter `status` when calling `signal_workflow_task_a_sync`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/tasks/{workflowId}/{status}/signal', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def signal_workflow_task_sync(self, body, workflow_id, status, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.signal_workflow_task_sync(body, workflow_id, status, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.signal_workflow_task_sync_with_http_info(body, workflow_id, status, **kwargs)  # noqa: E501
        else:
            (data) = self.signal_workflow_task_sync_with_http_info(body, workflow_id, status, **kwargs)  # noqa: E501
            return data

    def signal_workflow_task_sync_with_http_info(self, body, workflow_id, status, **kwargs):  # noqa: E501
        """Update running task in the workflow with given status and output synchronously and return back updated workflow  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.signal_workflow_task_sync_with_http_info(body, workflow_id, status, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'workflow_id', 'status', 'return_strategy']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `signal_workflow_task_sync`")  # noqa: E501
        # verify the required parameter 'workflow_id' is set
        if ('workflow_id' not in params or
                params['workflow_id'] is None):
            raise ValueError("Missing the required parameter `workflow_id` when calling `signal_workflow_task_sync`")  # noqa: E501
        # verify the required parameter 'status' is set
        if ('status' not in params or
                params['status'] is None):
            raise ValueError("Missing the required parameter `status` when calling `signal_workflow_task_sync`")  # noqa: E501
