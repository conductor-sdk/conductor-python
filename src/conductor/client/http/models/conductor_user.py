...
class ConductorUser:
    ...
    groups: Optional[List['Group']] = field(default=None)
    uuid: Optional[str] = field(default=None)
    encrypted_id: Optional[bool] = field(default=None)
    encrypted_id_display_value: Optional[str] = field(default=None)
    application_user: Optional[bool] = field(default=None)

    # Private backing fields
    _id: Optional[str] = field(init=False, repr=False)
    _name: Optional[str] = field(init=False, repr=False)
    _roles: Optional[List['Role']] = field(init=False, repr=False)
    _groups: Optional[List['Group']] = field(init=False, repr=False)
    _uuid: Optional[str] = field(init=False, repr=False)
    _encrypted_id: Optional[bool] = field(init=False, repr=False)
    _encrypted_id_display_value: Optional[str] = field(init=False, repr=False)
    _application_user: Optional[bool] = field(init=False, repr=False)

    # Keep original swagger_types and attribute_map for backward compatibility
    ...
    discriminator: Any = field(init=False, repr=False, default=None)
    ...
    def __post_init__(self):
        """Initialize private backing fields from dataclass fields"""
        self._id = self.id
        self._name = self.name
        self._roles = self.roles
        self._groups = self.groups
        self._uuid = self.uuid
        self._encrypted_id = self.encrypted_id
        self._encrypted_id_display_value = self.encrypted_id_display_value
        self._application_user = self.application_user
