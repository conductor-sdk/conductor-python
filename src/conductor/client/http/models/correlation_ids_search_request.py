...
class CorrelationIdsSearchRequest:
    ...
    _correlation_ids: List[str] = field(default=None, repr=False, init=False)
    _workflow_names: List[str] = field(default=None, repr=False, init=False)
    ...
    def __post_init__(self):
        ...
        if not hasattr(self, '_correlation_ids') or self._correlation_ids is None:
            self._correlation_ids = self.correlation_ids
        if not hasattr(self, '_workflow_names') or self._workflow_names is None:
            self._workflow_names = self.workflow_names
