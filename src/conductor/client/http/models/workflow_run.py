...
class WorkflowRun(object):
    ...
    def __init__(self, correlation_id=None, create_time=None, created_by=None, input=None, output=None, priority=None, request_id=None, status=None, tasks=None, update_time=None, variables=None, workflow_id=None, reason_for_incompletion: str = None):  # noqa: E501
