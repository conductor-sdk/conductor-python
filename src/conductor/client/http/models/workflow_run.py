...
class WorkflowRun:
    ...
    # Additional init parameter (not a dataclass field)
    reason_for_incompletion: InitVar[Optional[str]] = None

    # Private backing fields
    _correlation_id: Optional[str] = field(init=False, repr=False)
    _create_time: Optional[int] = field(init=False, repr=False)
    _created_by: Optional[str] = field(init=False, repr=False)
    _input: Optional[Dict[str, Any]] = field(init=False, repr=False)
    _output: Optional[Dict[str, Any]] = field(init=False, repr=False)
    _priority: Optional[int] = field(init=False, repr=False)
    _request_id: Optional[str] = field(init=False, repr=False)
    _status: Optional[str] = field(init=False, repr=False)
    _tasks: Optional[List[Task]] = field(init=False, repr=False)
    _update_time: Optional[int] = field(init=False, repr=False)
    _variables: Optional[Dict[str, Any]] = field(init=False, repr=False)
    _workflow_id: Optional[str] = field(init=False, repr=False)
    _reason_for_incompletion: Optional[str] = field(init=False, repr=False)
    ...
    def __post_init__(self, reason_for_incompletion: Optional[str]):
