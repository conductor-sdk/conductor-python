...
class TaskSummary(object):
    ...
    def __init__(self, workflow_id=None, workflow_type=None, correlation_id=None, scheduled_time=None, start_time=None, update_time=None, end_time=None, status=None, reason_for_incompletion=None, execution_time=None, queue_wait_time=None, task_def_name=None, task_type=None, input=None, output=None, task_id=None, external_input_payload_storage_path=None, external_output_payload_storage_path=None, workflow_priority=None):  # noqa: E501
