...
class TaskResult(object):
    ...
    def __init__(self, callback_after_seconds=None, external_output_payload_storage_path=None, logs=None, output_data=None, reason_for_incompletion=None, status=None, sub_workflow_id=None, task_id=None, worker_id=None, workflow_instance_id=None):  # noqa: E501
