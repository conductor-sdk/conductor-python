...
class TestRerunWorkflowRequestSerialization(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.request_obj = RerunWorkflowRequest(
            re_run_from_workflow_id=self.request_json["reRunFromWorkflowId"],
            workflow_input=self.request_json["workflowInput"],
            re_run_from_task_id=self.request_json["reRunFromTaskId"],
            task_input=self.request_json["taskInput"],
            correlation_id=self.request_json["correlationId"]
        )
