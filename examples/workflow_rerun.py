...
def start_workflow(workflow_client: WorkflowClient) -> WorkflowRun:
    ...
    return workflow_client.execute_workflow(start_workflow_request=request, wait_until_task_ref='simple_task_ref1_case1_1')
...
def main():
    ...
    print(f'You can monitor the workflow in the UI here: http://localhost:5001/execution/{workflow_id}')
    ...
    workflow_client.update_state(workflow_id=workflow_id, update_requesst=update_request, wait_until_task_ref_names='simple_task_ref1_case1_2', wait_for_seconds=0)
    ...
    workflow_run = workflow_client.update_state(workflow_id=workflow_id, update_requesst=update_request,
                                 wait_until_task_ref_names='simple_task_ref2_case1_1', wait_for_seconds=0)
